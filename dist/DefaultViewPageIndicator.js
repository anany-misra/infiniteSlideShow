...
class DefaultViewPageIndicator extends React.Component {
    ...
    renderIndicator(page) {
        return (React.createElement(react_native_1.TouchableOpacity, { style: styles.tab, key: 'idc_' + page, onPress: () => this.props.goToPage && this.props.goToPage(page) },
            React.createElement(react_native_1.View, { style: [styles.dot, this.props.dotStyle] })));
    }
    render() {
        ...
        return (React.createElement(react_native_1.View, { style: styles.tabs, onLayout: (event) => {
            ...
            indicators,
            React.createElement(react_native_1.Animated.View, { style: [styles.curDot, { left }, this.props.activeDotStyle] })));
    }
}
